...
MESHCORE_SUB_GET_BATTERY = 0x13
MESHCORE_SUB_GET_MCU_TEMP = 0x14
MESHCORE_SUB_GET_SENSORS = 0x15
MESHCORE_SUB_GET_DEVICE_NAME = 0x16
MESHCORE_SUB_PING = 0x17
MESHCORE_SUB_PONG = MESHCORE_SUB_PING | 0x80
MESHCORE_SUB_REBOOT = 0x18
